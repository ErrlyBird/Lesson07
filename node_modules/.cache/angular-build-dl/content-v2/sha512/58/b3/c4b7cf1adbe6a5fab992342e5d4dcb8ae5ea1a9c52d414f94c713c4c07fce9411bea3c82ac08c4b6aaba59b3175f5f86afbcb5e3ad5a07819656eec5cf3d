...
class AppComponent {
    constructor() {
        this.title = 'Dallas Has Updated His Title';
    }
}
...
module.exports = __webpack_require__(/*! C:\Users\HPPAVILION\Desktop\Wake Tech Labs\WEB215\Lesson07\src\main.ts */"./src/main.ts");
